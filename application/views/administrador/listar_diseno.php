...
<body id="Web 3.0" data-spy="scroll" data-target=".navbar" data-offset="60">
	...
	<table class="table table-bordered">
		...
		<?php $i=0; foreach ($disenos as $key => $value) { $i++ ?>
			...
			<tr>
					...
					<td>
						<a href="<?php echo base_url();?>Administrador/cambiar_status_diseno/<?php echo $value['id_diseno']; ?>/<?php echo $value['estado']; ?>" class="btn btn-info btn-sm btn-block"><i class="glyphicon glyphicon-eye-open"></i>&nbsp;Estado</a>
					</td>
				</tr>
