	...
	<table class="table table-bordered">
		...
		<?php $i=0; foreach ($personas as $key => $value) { $i++ ?>
			...
			<tr>
					...
					<td>
						<a href="" class="btn btn-warning btn-sm btn-block"><i class="glyphicon glyphicon-pencil"></i>&nbsp;Editar</a>
						<a href="" class="btn btn-info btn-sm btn-block"><i class="glyphicon glyphicon-eye-open"></i>&nbsp;Estado</a>
					</td>
				</tr>
