...
<body id="Web 3.0" data-spy="scroll" data-target=".navbar" data-offset="60">
	...
	<div class="container">
		<form method="POST" action="<?php echo base_url();?>Administrador/guardar_datos_admin">
			...
			<div class="form-group">
				...
				<input type="text" name="apellido_materno" class="form-control" id="apellido_materno" placeholder="Apellido Materno" required>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="password" name="clave" class="form-control" id="password" placeholder="clave" required>
			</div>
